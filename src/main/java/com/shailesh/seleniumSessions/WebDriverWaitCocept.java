...
public class WebDriverWaitCocept {
...
//		email_ele.sendKeys("test@gmail.com");
		...
		doPresenceofElement(emailID, 5).sendKeys("test@gmail.com");
	 ...
	 */
	public static WebElement doPresenceofElement(By locator, int timeout) {
